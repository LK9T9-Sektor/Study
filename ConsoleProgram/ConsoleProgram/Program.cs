            ...
            select:
                ...
                switch (selection)
                {
                    ...
                    case "1":
                        ...
                        goto select;
                    case "2":
                        Console.WriteLine("_______________Получение данных из Implicit.cs__________________");
                    ...
                    case "4":
                        ...
                        goto select;
                    case "5":
                        Console.WriteLine("_______________Получение данных из BitHandling.cs__________________");
                        Console.WriteLine(new BitHandling().Action());
                        goto select;
                    case "6":
                        Console.WriteLine("_______________Получение данных из Assignment .cs_______________");
                    ...
                    case "7":
                        ...
                        goto select;
                    case "8":
                        Console.WriteLine("_______________Получение данных из Conditional.cs___________________");
                    ...
                    case "19":
                        ...
                        goto select;
                    case "20":
                        Console.WriteLine("______________Получение данных из Tuples.cs________________________");
                        new Tuples().Action();
                        goto select;
                    case "21":
                        Console.WriteLine("______________Получение данных из Oop_classes_objects.cs____________");
                        new Oop_classes_objects().Action();
                        goto select;
                    case "22":
                        Console.WriteLine("______________Получение данных из Structures.cs______________________");
                        new Structures().Action();
                        goto select;
                    case "23":
                        Console.WriteLine("______________Получение данных из Types.cs___________________________");
                        new Types().Action();
                        goto select;
                    case "24":
                        Console.WriteLine("______________Получение данных из ObjectsLikeParameters.cs___________________________");
                        new ObjectsLikeParameters().Action();
                        goto select;
                    case "25":
                        Console.WriteLine("______________Получение данных из AccessModifiers.cs___________________________");
